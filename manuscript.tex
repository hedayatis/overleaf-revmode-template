...
Both are recorded automatically, so the point-by-point response letter is a
by-product of the revision rather than a separate document written from memory.
...
One source, three documents, and a response letter that writes itself. The
alternative is a folder of files nobody trusts.
